<template>
  <div class="menuNar">
    ...
    <div style="margin-top: 5px">
      <el-image style="width: 100px; height: 30px" :src="logoUrl" :fit="'fill'"/>
    </div>
      ...
      <el-tooltip content="Bottom center" effect="customized">
        ...
        <template #content>
          <div class="menu_content">
            ...
            <div>
              <el-row :gutter="20">
                <el-col :span="12" :offset="6" style="text-align: center; cursor: pointer">
                  <span style="font-size: 15px; font-weight: bold; color: #256DC6;">
                    查看全部分类
                  </span>
...
export default {
  ...
  setup (props, { emit }) {
    // 分类数据
    // 家常菜热菜凉菜主食汤早餐午餐海鲜孕妇甜品粥宝宝食谱糕点微波炉
    const categories = [
      {
        id: '1',
        name: '常见菜式',
